"""
Django settings for biopython_api project.
...
SECRET_KEY = 'django-insecure-bled_z=&2704)(=fts#5cy*5i#i6z1(h*a!@66c9@z9s8n5m4h'
...
ROOT_URLCONF = 'biopython_api.urls'
...
WSGI_APPLICATION = 'biopython_api.wsgi.application'
